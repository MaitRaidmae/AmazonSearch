...
/***********************************************************************************************
  * Mait: 
  * This file is borrowed from the internet to implement signed requests to Amazon API.
  * URL: https://aws.amazon.com/code/Product-Advertising-API/2480
  */
using System;
...
namespace AmazonProductAPI
{
    class AmazonRequestHelper
    {
         ...
         *  CA: ecs.amazonaws.ca
         */
        public AmazonRequestHelper(string awsAccessKeyId, string awsSecretKey, string destination)
        {
